...
const CanvasWrapper: FC<{ children: ReactNode; reduced?: boolean }> = ({ children, reduced }) => (
  <Canvas dpr={reduced ? 1 : [1, 2]} frameloop={reduced ? 'never' : 'always'} className="w-full h-full relative">
    {children}
  </Canvas>
);
...
const Beams: FC<BeamsProps> = ({
  ...
  // Respect prefers-reduced-motion to stabilize visual regression
  ...
  return (
    <CanvasWrapper reduced={reduced}>
      <group rotation={[0, 0, degToRad(rotation)]}>
        <PlaneNoise paused={reduced} ref={meshRef} material={beamMaterial} count={beamNumber} width={beamWidth} height={beamHeight} />
